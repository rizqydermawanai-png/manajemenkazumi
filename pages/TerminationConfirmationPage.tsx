...
export const TerminationConfirmationPage = ({ currentUser, messages, setMessages, users, setUsers, setCurrentUser, addActivity, onConfirmAndProceedToLogout }: TerminationConfirmationPageProps) => {
    ...
    const handleConfirmAction = () => {
        ...
        addActivity('Manajemen Akun', `Pengguna ${currentUser.fullName} mengonfirmasi pemecatan dan akunnya dinonaktifkan.`, currentUser.uid);
