...
import type { UserData, PointLogEntry, PerformanceScore, Sanction, PerformanceReview } from '../types';
...
// Re-using components from PerformanceDashboardPage
...
const BreakdownBar: React.FC<BreakdownBarProps> = ({ label, score, icon: Icon, color }) => {
    const maxScore = 100; // Each category is normalized against a max potential
...
export const EmployeePerformanceDetailPage = ({ userId, users, onBack }: EmployeePerformanceDetailPageProps) => {
