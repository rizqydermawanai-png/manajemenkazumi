...
import { UserData, SurveyResponse, SurveyQuestion } from '../types';
...
export const SurveyPage = ({ surveyResponses, users, surveyQuestions, setSurveyQuestions, currentUser, addActivity }: SurveyPageProps) => {
    ...
    const handleDeleteQuestion = (questionId: string) => {
        ...
        if (window.confirm(`Anda yakin ingin menghapus pertanyaan ini?\n"${questionText}"`)) {
            ...
            addActivity('Survei', `Menghapus pertanyaan survei: "${questionText}"`);
    ...
    const handleSaveQuestion = (question: SurveyQuestion) => {
        ...
        addActivity('Survei', `${isEditing ? 'Mengedit' : 'Menambah'} pertanyaan survei: "${question.text}"`);
    ...
    const surveyData = useMemo(() => {
        ...
        surveyResponses.forEach(response => {
            response.answers.forEach(answer => {
                ...
                // Use the first question as the primary metric for overall satisfaction
