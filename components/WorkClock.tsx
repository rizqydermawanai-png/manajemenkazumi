    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed bottom-4 right-4 bg-white/80 backdrop-blur-md rounded-xl shadow-lg cursor-pointer p-3 flex items-center gap-3 text-slate-800 border z-50"
